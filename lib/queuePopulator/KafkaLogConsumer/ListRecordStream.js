...
class ListRecordStream extends stream.Transform {
     ...
     * @param {string} operationType mongo operation type
    ...
    _getType(operationType, objectMd) {
        switch (operationType) {
            ...
            case 'update':
                ...
                // to delete events coming from special collections other
    ...
    _getObjectMd(changeStreamDocument) {
        ...
        // fullDocument as they represent the exact changes that occurred

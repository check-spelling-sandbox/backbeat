...
class LogReader {
     ...
     *
     * This function may be overridden by subclasses, if source log
    ...
    _initializeLogOffset(done) {
        ...
        return this.logConsumer.readRecords({ limit: 1 }, (err, res) => {
            if (err) {
                ...
                // setup phase and fall back to starting from offset
    ...
    isSupportedOperation(record) {
        ...
        // Currently, only methods with a method ID < 10 are supported.

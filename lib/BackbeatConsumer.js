...
class BackbeatConsumer extends EventEmitter {
    ...
    _initConsumer() {
        ...
        // Therefore, a message could be consumed multiple times leading to:
    ...
    _bootstrapConsumer() {
        ...
        function consumeCb(err, messages) {
            ...
            messages.forEach(message => {
                ...
                if (bootstrapId) {
                    self._log.info('bootstrapping backbeat consumer: ' +
        ...
        producer.on('ready', () => {
            producerTimer = setInterval(() => {
                ...
                this._log.info('bootstrapping backbeat consumer: ' +
